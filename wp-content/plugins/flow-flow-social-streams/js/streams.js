...
<input class="" id="<%= uid %>-feed-timeline-type" type="radio" name="<%= uid %>-timeline-type" value="feed_timeline" />\
<label class="" for="<%= uid %>-feed-timeline-type">Public page with restrictions</label><br><br>\
